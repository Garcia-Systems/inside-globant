...
```mermaid
flowchart TB
    V[Business value: growth, efficiency, experience, resilience]
    E[Engagement: diagnosis, scope, team, governance, accountability]
    C[Capabilities: industry + Studio + engineering + platforms + locations]
    C --> E --> V
```
