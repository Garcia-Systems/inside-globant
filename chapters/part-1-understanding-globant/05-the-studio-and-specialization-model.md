...
```mermaid
flowchart TB
    I[Industry context\nMedia • Finance • Travel • Health • Retail]
    T[Technology/practice context\nAI • Cloud • Data • Platforms • Experience • Engineering]
    E[Client engagement]
    I --> E
    T --> E
    G[Geographic delivery pools] --> E
    A[Account and delivery governance] --> E
```
