...
```mermaid
flowchart TD
    A[Business problem] --> B[Relationship / opportunity]
    B --> C[Discovery]
    C --> D[Solution definition]
    D --> E[Commercial agreement]
    E --> F[Delivery organization]
    F --> G[Engineering and change]
    G --> H[Business outcome / evidence]
    H --> I[Account learning and possible expansion]
    I -. new need .-> C
```
