...
```mermaid
flowchart LR
    D[Demand knowledge] <--> X[Customer-facing commercial + technical capability]
    X <--> E[Specialized global engineering]
    E --> V[Delivered and adopted value]
    V -. trust and evidence .-> D
```
