...
```mermaid
flowchart LR
    F[Formula 1 business and product owners] -->|priorities and product accountability| P[Fan and event product portfolio]
    G[Globant digital product capability] -->|design, engineering and delivery support| P
    P --> X[Web, mobile and event touchpoints]
    X --> V[Target value: more coherent fan engagement]
    G <-->|official-partner rights and activation| F
```
